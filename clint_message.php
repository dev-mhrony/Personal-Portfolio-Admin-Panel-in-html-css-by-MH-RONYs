            ...
            <div class="content-wrapper">
                ...
                <div class=" content">
                    ...
                    <div class="row">
                                                ...
                                                <a href="#jared" data-toggle="tab" class="media-link">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="media-heading text-semibold">Jeremy
                                                            Victorino</span>
                                                        <span class="text-size-small text-muted display-block">Senior
                                                            designer</span>
                                                    </div>
                                                    <div class="media-right media-middle">
                        ...
                        <div class="tabbable tab-content-bordered content-group-lg col-lg-9">
                            <div class="tab-content">
                                <div class="tab-pane fade in active has-padding" id="james">
                                    <ul class="media-list chat-list content-group">
                                        ...
                                        <li class="media reversed">
                                            <div class="media-body">
                                                <div class="media-content">Far squid and that hello fidgeted and when.
                                ...
                                <div class="tab-pane fade has-padding" id="victoria">
                                    <ul class="media-list chat-list content-group">
                                        <li class="media">
                                            <div class="media-left">
                                                <a href="assets/images/placeholder.jpg">
